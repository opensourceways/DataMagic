...
@Component
public class GithubStarProcess implements DriverManager {
...
//        /doocs/advanced-java  /openeuler/kernel alibaba/fastjson2
    ...
    private List<StarDO> formatStr(RepoDO repoDO, List<String> prInfoList) {
        ...
        for (ArrayNode arrayNode : arrayNodeList) {
            starDOList.addAll(converter.toDOList(arrayNode, repoDO.getOwnerName(),repoDO.getRepoName(),"github"));
        }
        return starDOList;
    }
