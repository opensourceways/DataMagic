 ...
 */
@Component
public class RepoApplicationService {
     ...
     * @return 保存结果
     */
    private boolean saveRepoData(List<String> repoList){
        ...
        return repoService.saveOrUpdateBatch(repoDOList);
    }
