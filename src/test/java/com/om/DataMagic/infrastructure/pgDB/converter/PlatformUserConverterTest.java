...
public class PlatformUserConverterTest {
    ...
    void testTODOSuccess() {
        ...
        Assertions.assertEquals("my@deng123mian.com", platformUserDO.getEmail());
    }
    @Test
    @DisplayName("用户不存在")
    ...
    public String getUserListFromAPI(){
        return "{" +
                ...
                "  \"followers_url\": \"https://api.gitcode.com/api/v5users/deng123mian/followers\",\n" +
                "  \"html_url\": \"https://gitcode.com/deng123mian\",\n" +
                "  \"id\": \"650d67***139b49b41\",\n" +
                "  \"login\": \"deng123mian\",\n" +
                "  \"name\": \"麻凡\",\n" +
                "  \"type\": \"User\",\n" +
                "  \"url\": \"https://api.gitcode.com/api/v5/deng123mian\",\n" +
                "  \"bio\": \"Nacos是由阿里巴巴开源的服务治理中间件，集成了动态服务发现、配置管理和服务元数据管理功能，广泛应用于微服务架构中，简化服务治理过程。\",\n" +
                "  \"blog\": \"https://www.deng123mian.com\",\n" +
                "  \"company\": \"开发者\",\n" +
                "  \"email\": \"my@deng123mian.com\",\n" +
                "  \"followers\": 0,\n" +
                "  \"following\": 6,\n" +
